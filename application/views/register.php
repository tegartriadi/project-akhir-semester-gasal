            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Library Digital</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Halaman Registrasi🚀</h4>
              <p class="mb-4">Create Your Account!</p>

              <form action="<?= base_url('index.php/auth/simpan') ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" name="email" placeholder="Masukkan email" required></input>
                </div>
                <div class="mb-3">
