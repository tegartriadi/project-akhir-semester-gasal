        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <div class="menu-inner-shadow"></div>
            ...
            <ul class="menu-inner py-1">
              <!-- Dashboard -->
              <li class="menu-item <?= ($url ==NULL) ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/home') ?>" class="menu-link">
              ...
              <li class="menu-item <?= ($url == 'user') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/admin/user') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-user"></i>
                  <div data-i18n="User">User</div>
                </a>
              </li>
              <li class="menu-item <?= ($url == 'kategori') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/admin/kategori') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-table"></i>
                  <div data-i18n="kategori">Kategori Buku</div>
                </a>
              </li>
              <li class="menu-item <?= ($url == 'buku') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/admin/buku') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-book"></i>
                  <div data-i18n="buku">Buku</div>
                </a>
              </li>
              <li class="menu-item <?= ($url == 'peminjaman') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/admin/peminjaman') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-cart-alt"></i>
                  <div data-i18n="peminjam">Peminjaman</div>
                </a>
              </li>
                <?php } ?>
            ...
            <?php if ($this->session->userdata('role')=='Peminjam'){ ?>
              <li class="menu-item <?= ($url == 'buku') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/peminjam/buku') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-book"></i>
                  <div data-i18n="buku">Buku</div>
                </a>
              </li>
              <li class="menu-item <?= ($url == 'koleksi') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/peminjam/koleksi') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-book"></i>
                  <div data-i18n="buku">Koleksi</div>
                </a>
              </li>
              <li class="menu-item <?= ($url == 'peminjaman') ? 'active' : '' ?>">
                <a href="<?= base_url('index.php/peminjam/peminjaman') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-chart"></i>
                  <div data-i18n="peminjam">Riwayat Peminjaman</div>
                </a>
              </li>
                <?php } ?>
              <!-- Forms & Tables -->
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="<?= base_url('index.php/auth/password') ?>">
